...
<style>
    ...
    .formcontrol:focus,textarea:focus,.uneditable-input:focus,input[type="password"]:focus, input[type="search"]:focus, input[type="text"]:focus, input[type="email"]:focus, input[type="password-confirm"]:focus{
        border-color: #413f3d;
