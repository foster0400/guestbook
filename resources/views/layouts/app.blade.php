...
<style>
    ...
    textarea:focus,.formcontrol:focus,.uneditable-input:focus,input[type="password"]:focus, input[type="search"]:focus, input[type="text"]:focus, input[type="email"]:focus, input[type="password-confirm"]:focus, input[type="name"]:focus,input[type="address"]:focus{
